...
import DOMPurify from '../../../../../src/components/custom/purify.min';
...
export default baseMixins.extend().extend({
  ...
  computed: {
    ...
    internalValue: {
      get() {
        return typeof this.lazyValue == 'number' ? this.lazyValue : DOMPurify.sanitize(this.lazyValue)
      },

      set(val) {
        this.lazyValue = typeof val == 'number' ? val : DOMPurify.sanitize(val);
